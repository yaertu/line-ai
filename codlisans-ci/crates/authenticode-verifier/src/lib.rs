...
pub struct AuthenticodeResult {
    ...
    pub hash_evidence: EvidenceEnvelope,
...
pub enum AuthenticodeError {
    #[error(transparent)]
    Hash(#[from] hash_engine::HashError),
    #[error(transparent)]
    Discovery(#[from] windows_sdk_discovery::DiscoveryError),
    #[error(transparent)]
    Process(#[from] process_runner::ProcessError),
    #[error(transparent)]
