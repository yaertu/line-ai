	...
	return (
		...
		>
					...
					>
						{attachments.map((attachment, index) => (
							...
							>
								...
								{attachment.contentKind === "binary" ? (
									<span className="rounded bg-muted px-1 py-0.5 text-[0.62rem] text-muted-foreground">
										ikili · metadata
									</span>
								) : null}
								{onRemoveAttachment ? (
			...
			<textarea
				...
				className="max-h-64 w-full resize-none bg-transparent px-4 pt-3 pb-2 font-normal text-[length:var(--line-ai-composer-font-size)] leading-6 tracking-[-0.006em] outline-none placeholder:font-normal placeholder:text-muted-foreground/90"
				disabled={disabled}
